...
class Discriminator(torch.nn.Module):
    ...
    def __init__(
        ...
        if 'gpt2' in pretrained_model:
            ...
            self.encoder = AutoModelForCausalLM.from_pretrained(pretrained_model, output_hidden_states=True).half()
...
def evaluate_performance(data_loader, discriminator, device='cpu'):
    ...
    print("c0", c0_cnt / c0_sum, "c1", c1_cnt / c1_sum)
...
def train_discriminator(
    ...
    classifier_head_fp_pattern = os.path.join(
        output_fp, "{}_epoch".format(dataset) + "_{}.pt"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_fp", default="test",
