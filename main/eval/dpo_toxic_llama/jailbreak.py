...
def main():
    ...
    parser.add_argument('--max_token', type=int, default=500, help='Maximum context length')
    ...
    sampling_params = vllm.SamplingParams(
        ...
        max_tokens=args.max_token,  # maximum we can pass to roberta
    )
    ...
    file_name = f'jailbreak{0 if args.first else 1}-tmp.json'
